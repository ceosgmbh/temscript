...
print("df_mode_string=%s" % client.get_df_mode_string())
print("Changing df_mode...")
client.set_df_mode(1)
print("df_mode=%s" % client.get_df_mode())
print("df_mode_string=%s" % client.get_df_mode_string())
print("stem_magnification2=%s" % client.get_stem_magnification())
print("instrument_mode=%s" % client.get_instrument_mode())
print("instrument_mode_string=%s" % client.get_instrument_mode_string())
print("illumination_mode=%s" % client.get_illumination_mode())
print("illumination_mode_string=%s" % client.get_illumination_mode_string())
print("spot_size_index=%s" % client.get_spot_size_index())
print("condenser_mode=%s" % client.get_condenser_mode())
print("condenser_mode_string=%s" % client.get_condenser_mode_string())
